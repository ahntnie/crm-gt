...
import 'package:crm_gt/data/models/response/authentication/authorities_data_response.dart';
...
class LoginRepoImpl extends BaseRepository implements LoginRepo {
  ...
  Future<Login> requestLogin(LoginRequest loginRequest) async {
    ...
    final loginResponse = AuthoritiesDataResponse.fromJson(jsonDecode(res.data?.data));
